<?php
   ...
   * Description: Create amazing landing pages from your wordpress site. Monitor analytics and improve conversion rates, host your landing pages anywhere and more.
   * Version: 1.1
   * Author: Wishpond
